...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { body: @share.body, descriptions: @share.descriptions, title: @share.title, type_id: @share.type_id, user_id: @share.user_id }
    end
  ...
  test "should update share" do
    patch :update, id: @share, share: { body: @share.body, descriptions: @share.descriptions, title: @share.title, type_id: @share.type_id, user_id: @share.user_id }
    assert_redirected_to share_path(assigns(:share))
  end
